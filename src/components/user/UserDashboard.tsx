    ...
    <Box>
      ...
      <Grid container spacing={3}>
        ...
        <Grid item xs={12} sm={6} md={3}>
          ...
          >
            <CardContent>
              <ArrowForward sx={{ fontSize: 48, color: 'primary.main', mb: 1 }} />
                ...
                {availableBookings.slice(0, 3).map((booking) => (
                  ...
                  >
                    <CardContent sx={{ p: 2 }}>
                      ...
                      <Chip
                        label={`${booking.slots.filter(s => !s.isBooked).length} slots available`}
                        size="small"
                        color="success"
                        variant="outlined"
                      />
                    ...
                    <Grid item xs={12} md={4} key={booking.id}>
                      <Card variant="outlined">
                        <CardContent>
                          ...
                          <Box sx={{ display: 'flex', alignItems: 'center', mb: 1 }}>
                            <CalendarMonth sx={{ fontSize: 16, mr: 1, color: 'text.secondary' }} />
